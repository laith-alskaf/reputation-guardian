...
class WebhookService(IWebhookService):
    ...
    def process_review(self, dto):
        ...
        cleaned_text = self.sentiment_service.clean_text(dto.text)
        sentiment = self.sentiment_service.analyze_sentiment(cleaned_text)
        toxicity = self.sentiment_service.analyze_toxicity(cleaned_text)
        review_type = self.sentiment_service.classify_review(sentiment, toxicity)
        ...
        quality_check = self.sentiment_service.detect_review_quality(
